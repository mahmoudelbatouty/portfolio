...
export const experience: ExperienceEntry[] = [
  ...
  },
  {
    ...
    location: "Remote",
    bullets: [
      "Architected AI agents with defined goals, system instructions, memory, context management, tool permissions, triggers, guardrails, evaluation criteria, and human-in-the-loop escalation for reliable autonomous execution.",
      "Built Model Context Protocol (MCP) workflows connecting Claude and coding agents to APIs, databases, browser tools, and development systems; created reusable skills and structured prompts for tool selection, retrieval, and multi-step orchestration.",
      "Designed multi-agent and bot-based automations that decomposed operational workflows into specialized agents with shared context, task handoffs, failure recovery, observability, and approval checkpoints.",
    ],
  },
  {
